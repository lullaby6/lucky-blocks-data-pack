execute store result score @s lucky_block.random run random value 1..3
...
# execute if score @s lucky_block.random matches 4 run say summon loot
# execute if score @s lucky_block.random matches 5 run say setblock chest loot