execute store result score @s lucky_block.random run random value 1..6
...
execute if score @s lucky_block.random matches 6 run return run function lucky_block:random/summon/custom/random